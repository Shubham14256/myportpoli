            ...
            >
              ...
              <div className="glass-morphism rounded-2xl p-8 h-full border border-cyber-blue/20 group-hover:border-cyber-blue/50 transition-all duration-300 flex flex-col relative z-10">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="mt-6 w-full px-4 py-3 rounded-lg border border-cyber-blue/30 text-cyber-blue text-sm font-semibold hover:bg-cyber-blue/10 hover:border-cyber-blue transition-all"
                >
                  View Project →
                </motion.button>
              </div>
